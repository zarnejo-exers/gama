/*******************************************************************************************************
 *
 * IScope.java, in msi.gama.core, is part of the source code of the GAMA modeling and simulation platform (v.1.9.2).
 *
...
public interface IScope extends Closeable, IBenchmarkable {
	...
	default void logLastVarChange(IAgent target, IAgent caller, IScope exec, String fxn_log) {}
	int getLogID();
	void incrementLogID();
